    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameChoice", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameResult_AspNetUsers_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GameResult_GameChoice_ComputerChoiceId",
                        column: x => x.ComputerChoiceId,
                        principalSchema: "dbo",
                        principalTable: "GameChoice",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GameResult_GameChoice_PlayerChoiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameResult_ComputerChoiceId",
                schema: "dbo",
                table: "GameResult",
                column: "ComputerChoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_GameResult_PlayerChoiceId",
                schema: "dbo",
                table: "GameResult",
